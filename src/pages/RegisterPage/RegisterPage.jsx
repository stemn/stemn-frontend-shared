...
// Container Actions
import { register, nextBackground, authenticate } from 'stemn-shared/misc/Auth/Auth.actions.js';
      ...
      <div className={classNames(classes.formPanel, 'flex', 'layout-column', 'layout-align-space-between')}>
        ...
        <form onSubmit={this.submit}>
          ...
          <div className="layout-row layout-align-end">
           ...
           <div className="layout-row">
             <Button onClick={() => dispatch(authenticate('linkedin'))}
             style={{marginRight: '5px'}}
             className="flex linkedin"
            type="button">Linkedin</Button>
            <Button onClick={() => dispatch(authenticate('facebook'))}
    ...
    return (
      <div className="flex rel-box">
        ...
        <SimpleIconButton
          ...
          onClick={() => dispatch(nextBackground())}
